...
public class HowToFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        wvHowTo.setBackgroundColor(0x00000000); // The 0x00000000 is the ARGB code for fully transparent.

        wvHowTo.loadUrl("file:///android_asset/html/index.html");

        // Make sure the HTML content does not have a background style that overrides this setting
        // You may need to adjust your HTML/CSS accordingly
